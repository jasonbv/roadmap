...
function buildRoadmap(response) {
	...
	roadmapItems.each(function(index,row){
		...
		finalRoadmapItemString += "<tr><td class='label'>Eng Mgr:</td><td class='field'>" + row.c[dataEngMgr].v + "</td></tr>"
		finalRoadmapItemString += "<tr><td class='label'>Tech Lead:</td><td class='field'>" + row.c[dataEngLead].v + "</td></tr>"
		finalRoadmapItemString += "<tr><td class='label'>Doc Lead:</td><td class='field'>" + row.c[dataDocLead].v + "</td></tr>"
